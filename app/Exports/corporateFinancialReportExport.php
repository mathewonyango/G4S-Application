...
class corporateFinancialReportExport implements FromQuery, WithHeadings, ShouldAutoSize, WithEvents, WithTitle, WithMapping
{
    use Exportable;
    ...
    function __construct($corporate,$fromDate, $toDate)
    {
...
// dd($corporate);
    ...
    public function query()
    {
        ...
        ->where('corporate_id', $this->corporate)
