...
class paymentExport implements FromQuery, WithHeadings, ShouldAutoSize, WithEvents, WithTitle, WithMapping
{
    use Exportable;
    ...
    function __construct($paymentMethod,$fromDate, $toDate)
    {
