...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        .gradient {
            background: linear-gradient(to right, #f05024 0%, #1c2124 100%);
        }
...
<body class="body"
      style="padding:0 !important; margin:0 auto !important; display:block !important; min-width:100% !important; width:100% !important; -webkit-text-size-adjust:none;">
<center>
    <table width="100%" border="0" cellspacing="0" cellpadding="0"
           style="margin: 0; padding: 0; width: 100%; height: 100%;" bgcolor="#E6E6E6" class="gwfw">
        <tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="mpx-10">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td class="img-center p-30 px-15"
                                                                            ...
                                                                            <a href="{{route('index')}}"
                                                                               target="_blank"><img
                                                                                    src="{{asset('assets/images/AO_logo.png')}}"
                                                                                    width="150"
                                                                                    border="0" alt=""/></a>
                                                                        </td>
                                                                    </tr>
                                                                                        ...
                                                                                        <table width="100%" border="0"
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="title-36 a-center pb-15"
                                                                                                    ...
                                                                                                    <strong>Confirm It's true</strong>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td class="text-16 lh-26 a-center pb-25"
                                                                                                    ...
                                                                                                    Hi {{$user->first_name}}, Welcome to {{config('app.name')}}.
                                                                                                    <small style="display: block;">
                                                                                                       We got a Notification that you need to reset your Password.Click the link below
                                                                                                    </small>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td class="p-15 mpx-15" bgcolor="#5E2D91"
                                                    style="border-radius: 0 0 10px 10px; padding: 15px;">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td class="text-14 lh-24 a-center c-white l-white pb-20"
                                                                ...
                                                                <h3 class="c-white">Your Ideal Service Partner</h3>
                                                                <span class="d-block">info@aogroup.co.za</span>
                                                                <a href="mailto:{{config('app.firm_email')}}"
                                                                   target="_blank"
                                                                   class="link c-white"
                                                                   style="text-decoration:none; color:#ffffff;"><span
                                                                        class="link c-white"
                                                                        style="text-decoration:none; color:#ffffff;">{{config('app.firm_email')}}</span></a>
                                                                <a href="{{config('app.firm_url')}}" target="_blank"
                                                                   class="link c-white d-block"
                                                                   style="text-decoration:none; color:#ffffff;"><span
                                                                        class="link c-white"
                                                                        style="text-decoration:none; color:#ffffff;">{{url_site_label(config('app.firm_url'))}}</span></a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="text-12 lh-22 a-center c-grey- l-grey py-20"
                                                    ...
                                                    <a href="{{config('app.firm_url')}}" target="_blank"
                                                       ...
                                                       style="text-decoration:none; color:#6e6e6e;"><span
                                                            class="link c-grey"
                                                            style="white-space: nowrap; text-decoration:none; color:#6e6e6e;">{{date('Y')}} &copy; All Rights Reserved. {{config('app.firm_name')}}</span></a>
                                                </td>
                                            </tr>
                                        </table>                                            <!-- END Bottom -->
                                    </td>
