                                                                ...
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td class="img-center p-30 px-15"
                                                                            ...
                                                                            <a href="{{route('index')}}"
                                                                               target="_blank"><img
                                                                                    src="{{asset('img/assets/images/AO_logo.png')}}"
                                                                                    width="150"
                                                                                    border="0" alt=""/></a>
                                                                        </td>
                                                                    </tr>
                                                                                        ...
                                                                                        <table width="100%" border="0"
                                                                                            ...
                                                                                            <td class="text-16 lh-26 a-center pb-25"
                                                                                                ...
                                                                                                <small style="display: block;">
                                                                                                    Use the following code to proceed with login
                                                                                                </small>
                                                                                            </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td align="center">
                                                                                                    ...
                                                                                                    <table border="0"
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td class="title-36 a-center pb-5"
                                                                                                                style="font-size:36px; line-height:30px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 5px;">
                                                                                                                <strong>{{$code}}</strong>
                                                                                                            </td>
                                                                                                        </tr>
