...
@section('breadcrumb')
    <div class="row page-title">
        <div class="col-md-12">
            ...
            <h4 class="mb-1 mt-0">Register Assets</h4>
        </div>
    </div>
@endsection
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <h4 class="header-title mt-0 mb-1">New Asset</h4>
                        </div>
                    </div>
                    <br>
                    {{-- {{ dd($result) }} --}}
                    ...
                    <div class="row">
                        <div class="col-xl-10">
                            <form action="{{ route('asset.submit-asset') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group row mb-3">
                                    <label for="role" class="col-3 col-form-label">Select Region</label>
                                    <div class="col-9">
                                    <select name="region" id="region" class="form-group custom-select" required>
    <option value="" selected>--Select region--</option>
    @foreach($regions as $r)
        <option value="{{ $r->id }}">{{ ucwords($r->town_name) }}</option>
    @endforeach
</select>
                                ...
                                <div class="form-group row mb-3">
                                    <label for="cogc" class="col-3 col-form-label"> Brand Name</label>
                                    <div class="col-9">
                                ...
                                <div class="form-group row mb-3">
                                    <label for="cogc" class="col-3 col-form-label"> Model Name</label>
                                    <div class="col-9">
                                ...
                                <div class="form-group row mb-3">
                                    <label for="cogc" class="col-3 col-form-label"> Engine Capacity</label>
                                    <div class="col-9">
                                ...
                                <div class="form-group row mb-3">
                                    <label for="cogc" class="col-3 col-form-label"> Make Name</label>
                                    <div class="col-9">
                                ...
                                <div class="form-group row mb-3">
                                    <label for="cogc" class="col-3 col-form-label"> Reg No.</label>
                                    <div class="col-9">
