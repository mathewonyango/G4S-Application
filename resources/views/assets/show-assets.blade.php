            ...
            <div class="card">
                <div class="card-body">
                    <div class="col-lg-12">
                        ...
                        <a href="{{ route('asset.create-assetForm') }}"
                           class="btn btn-sm btn-soft-primary float-right  mr-2"
                           data-toggle="Create Rider">
                            <i class="uil uil-plus"> Add an asset</i>
                        </a>
                </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <h4 class="header-title mt-0 mb-1">All Assets</h4>
                        </div>
                    </div>
                    <br>
                    @if(count($bikes))
                                        ...
                                        <div class="btn-group">
                                          ...
                                          <div class="dropdown-menu">
                                              ...
                                              <!-- <form action="{{ route('asset.return-bike') }}" method="get">
                                                @csrf
                                                <input type="hidden" name="bike_id" value="{{ $bike->id }}" />
                                              <button class="dropdown-item btn btn-link" href="#">Bike return</button>
                                            </form> -->
                                            ...
                                            <form action="{{ route('asset.riders-history') }}" method="get">
                                                @csrf
                                                <input type="hidden" name="bike_id" value="{{ $bike->id }}" />
                                              <button class="dropdown-item btn btn-link" href="#">Driver  History</button>
                                            </form>
                                          </div>
                                        </div></td>
