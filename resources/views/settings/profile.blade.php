                ...
                <div class="card-body">
                    <div class="text-center mt-3">
                        <img src="/storage/avatars/{{ auth()->user()->avatar }}" alt=""
                             class="avatar-lg rounded-circle" rel="tooltip" data-placement="top"
                             title="Click to change image"/>
                        <h5 class="mt-2 mb-0">{{ auth()->user()->first_name .' '. auth()->user()->last_name }}</h5>
                        <h6 class="text-muted font-weight-normal mt-2 mb-0">{{ strtoupper(auth()->user()->type) }}
                        </h6><br>
            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-pills navtab-bg nav-justified" id="pills-tab" role="tablist">
                        ...
                        @can('change_password')
                            <li class="nav-item">
                                <a class="nav-link" id="pills-password-tab" data-toggle="pill" href="#pills-settings"
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-profile" role="tabpanel"
                            ...
                            <div class="row ml-2 mt-4">
                                <form action="{{ route('settings.upload-avatar') }}" method="post"
                        ...
                        <!-- password -->
                        <div class="tab-pane" id="pills-settings" role="tabpanel"
