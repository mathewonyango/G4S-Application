...
@section('breadcrumb')
    <div class="row page-title">
        <div class="col-md-12">
            ...
            <h4 class="mb-1 mt-0">New Percel</h4>
        </div>
    </div>
@endsection
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-xl-10">
                            ...
                            <form action="{{ route('parcel.price') }}" method="GET">
                                @csrf

                                <div class="form-group row mb-3">
                                    <label for="from" class="col-3 col-form-label">Sender location</label>
                                    <div class="col-9">
                                        <select name="from" id="from" class="form-group custom-select" required>
                                        @foreach($region as $r)
                                ...
                                <div class="form-group row mb-3">
                                    <label for="from" class="col-3 col-form-label">Receiver location</label>
                                    <div class="col-9">
                                        <select name="to" id="" class="form-group custom-select" required>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-9">
                                        <input type="quantity" class="form-control" id="quantity"
                                               ...
                                               required value="{{ old('quantity') }}" name="quantity">
                                    </div>
                                </div>
                                <br />
