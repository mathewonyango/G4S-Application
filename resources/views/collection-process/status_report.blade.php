...
<div class="col-sm-3">
    <form action="{{ route('report.status-report') }}" method="get">
        <div class="form-group">
            <label for="payment"> Sort  report by Status:</label>
            <select name="status" class="form-control">
                ...
                <option value="6">Pick Up Station</option>
        ...
        <button type="submit" name="submit" value="status" class="btn btn-primary">Submit</button>
