        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-xl-10">
                            <form action="{{ route('corporate.add_regions') }}" method="post">
                                @csrf
                                <div class="form-group row mb-3">
                                    <label for="firstName3" class="col-3 col-form-label">Town name</label>
                                    <div class="col-9">
                                        <input type="text" class="form-control" id="town_name" placeholder="Town Name"
                                                name="town_name">
                                    </div>
                                </div>
