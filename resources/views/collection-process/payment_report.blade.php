...
<div class="col-sm-3">
    <form action="{{ route('report.payment-report') }}" method="get">
        <div class="form-group">
            <label for="payment">Sort report by Payment Method:</label>
        ...
        <button type="submit" name="submit" value="paymentMethod" class="btn btn-primary">Submit</button>
    </form>
</div>
</div>
