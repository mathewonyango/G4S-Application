                       ...
                       {{-- //     {{ route('location.create') }} --}}
                            " method="post">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-9">
                                        <select class="form-control" id="group account number" placeholder="Transaction"
                                               required value="{{ old('transaction') }}" name="transaction">
                                               <option>--Select--</option>
                                               <option value="transaction">B2C - Withdrawal</option>
                                            </select>
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                    <label for="locationName" class="col-3 col-form-label">Account Number</label>
                                    <div class="col-9">
                                        <input type="text" class="form-control" id="group account number" placeholder="Account Number"
